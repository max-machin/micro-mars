...
const CardProductDetail = ({
  ...
  React.useEffect(() => {
    setExponentProducts(
      mockProducts.dataProduct.filter(
        (product) => product.exponent_name === exponentName
      )
    );
  }, [exponentName]);
        ...
        <>
          <div className="detail-card-open-modale">
            <img
              ...
              src={elementProduct.product_picture}
            ...
            <div className="info-product-detail background-element">
              <div className="card-header">
                <img
                  ...
                  src={elementProduct.exponent_picture}
              ...
              <span className="exponent-name">
                Exposé par {elementProduct.exponent_name}
              </span>
              <div className="footer-card-detail">
                <div className="counter-product">
                  ...
                  <button
                    className="button-add-panier"
                    onClick={() => {
                      useContextMain.addProductToOrder(
                        elementProduct,
                        nbProduct
                      );
                    }}
